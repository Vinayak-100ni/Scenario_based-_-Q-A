...
* Kubernetes detects node failure via heartbeats, marks node
...
* Use: - NVIDIA device plugin - GPU requests/limits - Node
...
* Build once → Tag immutable → Push to registry → Promote same
image.
...
* Use: - Security scans (Trivy) - SBOM generation - Image
...
* Signals: - rollout status - readiness probe failure -
...
* - Pin base image - Freeze dependencies - Set seeds - Version
...
* Use: - Object storage - PVC caching - Init containers -
